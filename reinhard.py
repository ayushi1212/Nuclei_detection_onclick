...
# ife = np.load("/content/drive/MyDrive/Yughender/Conic_Challenge/work_data/images.npy")
def reinhard(image,target) : 
    n=reinNormalizer() 
    n.rfit(target) 
    img =n.rtransform(image)
    return img 
